...
/**
 * Sample implementation of eu.inmite.android.lib.dialogs.BaseDialogFragment - styled list of
 * items.
 *
...
public class FavoriteCharacterDialogFragment extends BaseDialogFragment {
  ...
  public Builder build(Builder builder) {
    ...
    ListAdapter adapter =
        new ArrayAdapter<String>(getActivity(), R.layout.item_list, R.id.list_item_text,
            getItems());
